...
const file_helloworld_helloworld_helloworld_proto_rawDesc = "" +
	"\n" +
	"&helloworld/helloworld/helloworld.proto\x12\n" +
	"helloworld\"\"\n" +
	...
	"\rSayHelloAgain\x12\x18.helloworld.HelloRequest\x1a\x16.helloworld.HelloReply\"\x00B\x8e\x01\n" +
	"\x1bio.grpc.examples.helloworldB\x0fHelloWorldProtoP\x01Z\\github.com/LeeDark/go-microservices-starter/grpc-playground/helloworld/helloworld;helloworldb\x06proto3"

var (
	file_helloworld_helloworld_helloworld_proto_rawDescOnce sync.Once
	file_helloworld_helloworld_helloworld_proto_rawDescData []byte
)
...
func file_helloworld_helloworld_helloworld_proto_rawDescGZIP() []byte {
	file_helloworld_helloworld_helloworld_proto_rawDescOnce.Do(func() {
		file_helloworld_helloworld_helloworld_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_helloworld_helloworld_helloworld_proto_rawDesc), len(file_helloworld_helloworld_helloworld_proto_rawDesc)))
	})
...
var file_helloworld_helloworld_helloworld_proto_goTypes = []any{
...
func file_helloworld_helloworld_helloworld_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_helloworld_helloworld_helloworld_proto_rawDesc), len(file_helloworld_helloworld_helloworld_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   1,
