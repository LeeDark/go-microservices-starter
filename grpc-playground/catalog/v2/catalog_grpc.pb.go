...
const (
	CatalogService_GetProduct_FullMethodName   = "/catalog.v2.CatalogService/GetProduct"
	CatalogService_ListProducts_FullMethodName = "/catalog.v2.CatalogService/ListProducts"
)
