...
const file_catalog_v1_catalog_proto_rawDesc = "" +
	...
	"\aproduct\x18\x01 \x01(\v2\x13.catalog.v1.ProductR\aproduct\"Q\n" +
	...
	"\fListProducts\x12\x1f.catalog.v1.ListProductsRequest\x1a .catalog.v1.ListProductsResponseBRZPgithub.com/LeeDark/go-microservices-starter/grpc-playground/catalog/v1;catalogv1b\x06proto3"
...
var file_catalog_v1_catalog_proto_depIdxs = []int32{
	...
	2, // 4: catalog.v1.CatalogService.GetProduct:output_type -> catalog.v1.GetProductResponse
	4, // 5: catalog.v1.CatalogService.ListProducts:output_type -> catalog.v1.ListProductsResponse
