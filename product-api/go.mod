...
replace github.com/LeeDark/go-microservices-starter/currency => ../currency

require (
	github.com/LeeDark/go-microservices-starter/currency v0.0.0-00010101000000-000000000000
